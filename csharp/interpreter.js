...
(function () {
  ...
  CSharpInterpreter.prototype._transpile = function (code) {
    ...
    var preamble = [
      ...
      'var Key = { None: "None", Space: "Space", W: "W", A: "A", S: "S", D: "D", E: "E", F: "F", Q: "Q", R: "R", Shift: "Shift", LeftShift: "LeftShift", RightShift: "RightShift", Escape: "Escape", Enter: "Enter", Tab: "Tab", LeftArrow: "LeftArrow", RightArrow: "RightArrow", UpArrow: "UpArrow", DownArrow: "DownArrow" };',
      'var __csDefaultKeyControl = { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false };',
      'var __csKeyHandler = { get: function(target, prop) { if (prop in target) return target[prop]; return __csDefaultKeyControl; } };',
      'var Keyboard = { current: new Proxy({ spaceKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, wKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, sKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, aKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, dKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, eKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, leftShiftKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, anyKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, escapeKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, enterKey: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false } }, __csKeyHandler) };',
      'var Mouse = { current: { leftButton: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, rightButton: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, middleButton: { wasPressedThisFrame: true, isPressed: true, wasReleasedThisFrame: false }, scroll: { ReadValue: function(){ return {x: 0, y: 0}; } }, position: { ReadValue: function(){ return {x: 100, y: 100}; }, x: { ReadValue: function(){ return 100; } }, y: { ReadValue: function(){ return 100; } } }, delta: { ReadValue: function(){ return {x: 0, y: 0}; } } } };',
      'var Input = { GetKey: function(k){ return true; }, GetKeyDown: function(k){ return true; }, GetKeyUp: function(k){ return false; }, GetMouseButton: function(b){ return true; }, GetMouseButtonDown: function(b){ return true; }, GetMouseButtonUp: function(b){ return false; }, GetAxis: function(a){ return 0; }, GetAxisRaw: function(a){ return 0; }, mousePosition: {x: 100, y: 100, z: 0} };',
      'var KeyCode = { Space: "Space", W: "W", A: "A", S: "S", D: "D", E: "E", F: "F", Q: "Q", R: "R", LeftShift: "LeftShift", Escape: "Escape", Return: "Return" };',
      'var __csOutput = [];',
      'var __csWarnings = [];',
      'var __csErrors = [];',
      'var __csTime = 0;',
