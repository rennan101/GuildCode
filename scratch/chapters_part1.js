// Complete array of 38 chapters with didactics and 5 activities each
module.exports = [
  // -------------------------------------------------------------
  // CH 0: Variáveis e Tipos de Dados
  // -------------------------------------------------------------
  {
    id: 0, title: "A Forja dos Tipos e Variáveis", module: "Módulo 1 — Fundamentos de C#",
    theme: "Tipos Primitivos & Console Unity", character: "arkan", charName: "ARKAN VELOR", role: "MESTRE DA GUILDA",
    unlock: "Console da Dimensão", unlockIcon: "[C#]", xpReward: 70,
  ...
  // -------------------------------------------------------------
  // CH 1: Operadores e Expressões
  // -------------------------------------------------------------
  {
    id: 1, title: "Operadores e Expressões Aritméticas", module: "Módulo 1 — Fundamentos de C#",
    theme: "Aritméticos, Relacionais e Lógicos", character: "lyra", charName: "LYRA NEX", role: "ARQUIVISTA",
    unlock: "Prisma Lógico", unlockIcon: "[OP]", xpReward: 80,
  ...
  // -------------------------------------------------------------
  // CH 2: Condicionais (if, else, switch)
  // -------------------------------------------------------------
  {
    id: 2, title: "Condicionais e Tomada de Decisão", module: "Módulo 1 — Fundamentos de C#",
    theme: "Controle de Fluxo & Decisão", character: "arkan", charName: "ARKAN VELOR", role: "MESTRE DA GUILDA",
    unlock: "Bússola de Fluxo", unlockIcon: "[IF]", xpReward: 90,
  ...
  // -------------------------------------------------------------
  // CH 3: Loops (for, while, foreach)
  // -------------------------------------------------------------
  {
    id: 3, title: "Laços de Repetição e Loops", module: "Módulo 1 — Fundamentos de C#",
    theme: "For, While e Iteração Contínua", character: "elion", charName: "ELION RAVEN", role: "MESTRE ESCRIBA",
    unlock: "Anel do Laço", unlockIcon: "[LOOP]", xpReward: 100,
    conceptTitle: "LOOPS EM C#",
    conceptExpl: "Laços for repetem um bloco um número fixo de vezes com contador. Laços while repetem enquanto uma condição for verdadeira.",
    conceptCode: "using UnityEngine;\n\npublic class LoopsDemo : MonoBehaviour\n{\n    void Start()\n    {\n        for (int i = 1; i <= 3; i++) {\n            Debug.Log(\"Ciclo: \" + i);\n        }\n    }\n}",
    exampleTitle: "Exemplo — Contagem Progressiva",
    exampleCode: "using UnityEngine;\n\npublic class ExemploContagem : MonoBehaviour\n{\n    void Start()\n    {\n        int c = 1;\n        while (c <= 3) {\n            Debug.Log(\"Tick: \" + c);\n            c++;\n        }\n    }\n}",
    exampleOutput: "Tick: 1\nTick: 2\nTick: 3",
    experimentTitle: "Laboratório de Loops",
    experimentDesc: "Altere o limite do laço e observe as iterações.",
    experimentCode: "using UnityEngine;\n\npublic class TesteLoop : MonoBehaviour\n{\n    void Start()\n    {\n        for (int i = 0; i < 4; i++) Debug.Log(\"Onda #\" + (i+1));\n    }\n}",
    tutorialSteps: [
      {
        instruction: "Faça um loop for de 1 a 3 que imprima 'Passo ' + i:",
        starterCode: "using UnityEngine;\n\npublic class Teste : MonoBehaviour\n{\n    void Start()\n    {\n        \n    }\n}",
        solution: "using UnityEngine;\n\npublic class Teste : MonoBehaviour\n{\n    void Start()\n    {\n        for (int i = 1; i <= 3; i++) Debug.Log(\"Passo \" + i);\n    }\n}",
        hint: 'for (int i = 1; i <= 3; i++) Debug.Log("Passo " + i);'
      }
    ],
    acts: [
      {
        title: "Spawn Sequencial de Inimigos", diff: "easy",
        ...
        exp: "Inimigo #1 gerado\nInimigo #2 gerado\nInimigo #3 gerado", descTest: "Loop for sequencial"
      },
      {
        title: "Contagem Regressiva de Ignição com While", diff: "easy",
      ...
      {
        title: "Acúmulo de Pontos com Somatório", diff: "medium",
        ...
        exp: "Total Acumulado: 100", descTest: "Somatório com loop"
      },
      {
        title: "Filtro de Números Pares com Continue", diff: "medium",
        ...
        sol: "using UnityEngine;\n\npublic class Exercicio : MonoBehaviour\n{\n    void Start()\n    {\n        for (int i = 1; i <= 5; i++)\n        {\n            if (i % 2 != 0) continue;\n            Debug.Log(\"Par: \" + i);\n        }\n    }\n}",
        exp: "Par: 2\nPar: 4", descTest: "Uso do comando continue"
      },
      {
        title: "Interrupção Prematura com Break", diff: "medium",
        ...
        exp: "Alvo Encontrado no passo 3", descTest: "Uso do comando break"
      }
    ]
  }
];
