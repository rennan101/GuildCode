...
const AVATAR_SKILLS_DATA = {
    ...
    '23': {
        ...
        rarity: 'LEGENDARY',
        skillName: 'Grito de Guerra Carmesim',
        skillDesc: 'Na Raid, aumenta em +25% o ataque de todos os membros da party. Acumula com outros Nightblood na equipe.',
        bonusType: 'raid_party_atk',
        bonusValue: 0.25,
        baseHp: 710,
        baseAttack: 220,
        baseDefense: 90,
