/* ═══════════════════════════════════════════════════════════════
   ...
   Estrutura Padronizada: 2 Fáceis + 3 Médias (Sem Média-Avançada)
   ═══════════════════════════════════════════════════════════════ */
...
const SIDE_QUESTS = {
    ...
    0: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use scanf(\"%d\", &mana);"
                      },
                      {
                                "level": "II",
                                "text": "Multiplique por 3 no printf: printf(\"Mana Triplicada: %d\\n\", mana * 3);"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "15",
                                "expected": "Mana Triplicada: 45",
                                "description": "15 * 3 = 45"
                      },
                      {
                                "input": "30",
                                "expected": "Mana Triplicada: 90",
                                "description": "30 * 3 = 90"
                      }
            ],
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use float cristais = ouro / 2.5f;"
                      },
                      {
                                "level": "II",
                                "text": "Formate com %.2f: printf(\"Cristais: %.2f\\n\", cristais);"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "10",
                                "expected": "Cristais: 4.00",
                                "description": "10 / 2.5 = 4.00"
                      },
                      {
                                "input": "25",
                                "expected": "Cristais: 10.00",
                                "description": "25 / 2.5 = 10.00"
                      }
            ],
            validator: function(code, output) {
                            let errors = [];
        ...
        },
        {
            ...
            hints: [
                      ...
                      {
                                "level": "II",
                                "text": "Converta para float ao dividir por 3.0: float med = (a + b + c) / 3.0f;"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "10 20 30",
                                "expected": "Media: 20.0",
                                "description": "(10 + 20 + 30) / 3 = 20.0"
                      },
                      {
                                "input": "5 7 12",
                                "expected": "Media: 8.0",
                                "description": "(5 + 7 + 12) / 3 = 8.0"
                      }
            ],
            validator: function(code, output) {
                            let errors = [];
        ...
        },
        {
            ...
            hints: [
                      ...
                      {
                                "level": "II",
                                "text": "Para imprimir o código ASCII, use %d passando a variável c: printf(\"Runa: %c | Codigo: %d\\n\", c, c);"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "A",
                                "expected": "Runa: A | Codigo: 65",
                                "description": "ASCII de 'A' = 65"
                      },
                      {
                                "input": "Z",
                                "expected": "Runa: Z | Codigo: 90",
                                "description": "ASCII de 'Z' = 90"
                      }
            ],
            validator: function(code, output) {
                            let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Faça o cast para float: (float)dano / mana;"
                      },
                      {
                                "level": "II",
                                "text": "printf(\"Eficiencia: %.2f\\n\", (float)dano / mana);"
                      },
                      {
                                "level": "III",
                                "text": "scanf(\"%d %d\", &dano, &mana);\nprintf(\"Eficiencia: %.2f\\n\", (float)dano / mana);"
                      }
            ],
            tests: [
                      {
                                "input": "100 40",
                                "expected": "Eficiencia: 2.50",
                                "description": "100 / 40 = 2.50"
                      },
                      {
                                "input": "150 50",
                                "expected": "Eficiencia: 3.00",
                                "description": "150 / 50 = 3.00"
                      }
            ],
            validator: function(code, output) {
                            let errors = [];
    ...
    1: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "int n = 10; char c = 'A'; float f = 3.14;"
                      },
                      {
                                "level": "II",
                                "text": "printf(\"%d %c %f\", n, c, f);"
                      },
                      {
                                "level": "III",
                                "text": "int n = 10;\nchar c = 'A';\nfloat f = 3.14;\nprintf(\"%d %c %f\\n\", n, c, f);"
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Operador ternário: condição ? valorVerdadeiro : valorFalso"
                      },
                      {
                                "level": "II",
                                "text": "char rank = (nivel >= 10) ? 'A' : 'B';"
                      },
                      {
                                "level": "III",
                                "text": "char rank = (nivel >= 10) ? 'A' : 'B';\nprintf(\"Rank: %c\\n\", rank);"
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "7.0 / 2 = 3.5. Use %d para int e %f para float."
                      },
                      {
                                "level": "II",
                                "text": "int r1 = (int)resultado; printf(\"%d %f\", r1, resultado);"
                      },
                      {
                                "level": "III",
                                "text": "float resultado = 7.0 / 2;\nprintf(\"Int: %d\\n\", (int)resultado);\nprintf(\"Float: %f\\n\", resultado);"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Respeite a precedência: parênteses primeiro."
                      },
                      {
                                "level": "II",
                                "text": "int r = (x + y) * 2 - x / y; printf(\"%d\", r);"
                      },
                      {
                                "level": "III",
                                "text": "// (20+6)*2 = 52, 20/6 = 3, 52-3 = 49\nint r = (x + y) * 2 - x / y;\nprintf(\"Resultado: %d\\n\", r);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Resultado: 49",
                                "description": "Expressão correta"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
    ...
    2: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use módulo: n % 2 == 0 significa par."
                      },
                      {
                                "level": "II",
                                "text": "if (n % 2 == 0) printf(\"Par\"); else printf(\"Impar\");"
                      },
                      {
                                "level": "III",
                                "text": "if (n % 2 == 0) {\n    printf(\"Par\\n\");\n} else {\n    printf(\"Impar\\n\");\n}"
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use i % 3 == 0 para verificar."
                      },
                      {
                                "level": "II",
                                "text": "if (i % 3 == 0) printf(\"%d \", i);"
                      },
                      {
                                "level": "III",
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use for de 1 a 10 e multiplique."
                      },
                      {
                                "level": "II",
                                "text": "printf(\"%d x %d = %d\\n\", n, i, n * i);"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "5 x 1 = 5\n5 x 2 = 10\n5 x 3 = 15\n5 x 4 = 20\n5 x 5 = 25\n5 x 6 = 30\n5 x 7 = 35\n5 x 8 = 40\n5 x 9 = 45\n5 x 10 = 50",
                                "description": "Tabuada do 5 completa (1 a 10)"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Verifique i%3==0 e i%5==0, nessa ordem."
                      },
                      {
                                "level": "II",
                                "text": "if (i%3==0 && i%5==0) printf(\"GUILDCODE\"); else if (i%3==0) printf(\"GUILD\"); else if (i%5==0) printf(\"CODE\"); else printf(\"%d\", i);"
                      },
                      {
                                "level": "III",
                                "text": "if (i % 3 == 0 && i % 5 == 0) printf(\"GUILDCODE \");\nelse if (i % 3 == 0) printf(\"GUILD \");\nelse if (i % 5 == 0) printf(\"CODE \");\nelse printf(\"%d \", i);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "1 2 GUILD 4 CODE GUILD 7 8 GUILD CODE 11 GUILD 13 14 GUILDCODE",
                                "description": "Sequência de 1 a 15 com regras GUILDCODE"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use printf para cada turno e some ao total."
                      },
                      {
                                "level": "II",
                                "text": "printf(\"Turno %d: %d\\n\", i, dano); total += dano;"
                      },
                      {
                                "level": "III",
                                "text": "printf(\"Turno %d: %d\\n\", i, dano);\ntotal += dano;\n// No final:\nprintf(\"Total: %d\\n\", total);"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Turno 1: 1\nTurno 2: 4\nTurno 3: 2\nTurno 4: 2\nTurno 5: 4\nTurno 6: 1\nTurno 7: 0\nTurno 8: 1\nTurno 9: 4\nTurno 10: 2\nTotal: 21",
                                "description": "10 turnos de dano e soma total"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
    ...
    3: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Se n < 0, retorne -n. Senão, retorne n."
                      },
                      {
                                "level": "II",
                                "text": "int absoluto(int n) { if (n < 0) return -n; return n; }"
                      },
                      {
                                "level": "III",
                                "text": "int absoluto(int n) {\n    if (n < 0) return -n;\n    return n;\n}"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use um if para comparar."
                      },
                      {
                                "level": "II",
                                "text": "int maior(int a, int b) { return (a > b) ? a : b; }"
                      },
                      {
                                "level": "III",
                                "text": "int maior(int a, int b) {\n    if (a > b) return a;\n    return b;\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Maior: 25\nMaior: 30",
                                "description": "Maior de (10, 25) e (30, 15)"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use um loop para multiplicar exp vezes."
                      },
                      {
                                "level": "II",
                                "text": "int r = 1; for (int i = 0; i < exp; i++) r *= base; return r;"
                      },
                      {
                                "level": "III",
                                "text": "int potencia(int base, int exp) {\n    int r = 1;\n    for (int i = 0; i < exp; i++) r *= base;\n    return r;\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "2^3 = 8\n5^2 = 25",
                                "description": "Potências de 2^3 e 5^2"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Imprima [ depois n X's depois 10-n pontos depois ]."
                      },
                      {
                                "level": "II",
                                "text": "printf(\"[\"); for (int i=0;i<n;i++) printf(\"X\"); for (int i=n;i<10;i++) printf(\".\"); printf(\"]\\n\");"
                      },
                      {
                                "level": "III",
                                "text": "void imprimirBarra(int n) {\n    printf(\"[\");\n    for (int i = 0; i < n; i++) printf(\"X\");\n    for (int i = n; i < 10; i++) printf(\".\");\n    printf(\"]\\n\");\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "[XXX.......]\n[XXXXXXX...]\n[XXXXXXXXXX]",
                                "description": "Barras de progresso para 3, 7 e 10"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Retorne base * nivel + nivel * 5."
                      },
                      {
                                "level": "II",
                                "text": "int calcularATK(int base, int nivel) { return base * nivel + nivel * 5; }"
                      },
                      {
                                "level": "III",
                                "text": "int calcularATK(int base, int nivel) {\n    return base * nivel + nivel * 5;\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Arion: 75\nLyra: 60\nKael: 104",
                                "description": "ATK de Arion, Lyra e Kael"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
    ...
    4: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use um for decrescente de 4 até 0."
                      },
                      {
                                "level": "II",
                                "text": "for (int i = 4; i >= 0; i--) printf(\"%d \", vet[i]);"
                      },
                      {
                                "level": "III",
                                "text": "for (int i = 4; i >= 0; i--) {\n    printf(\"%d \", vet[i]);\n}"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Assuma que vet[0] é o maior e menor, depois compare."
                      },
                      {
                                "level": "II",
                                "text": "int maior = vet[0]; for ... if (vet[i] > maior) maior = vet[i];"
                      },
                      {
                                "level": "III",
                                "text": "int maior = vet[0], menor = vet[0];\nfor (int i = 1; i < 5; i++) {\n    if (vet[i] > maior) maior = vet[i];\n    if (vet[i] < menor) menor = vet[i];\n}\nprintf(\"Maior: %d Menor: %d\\n\", maior, menor);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Maior: 50 Menor: 5",
                                "description": "Maior (50) e menor (5)"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Verifique se vet[i] % 2 == 0 antes de somar."
                      },
                      {
                                "level": "II",
                                "text": "if (vet[i] % 2 == 0) soma += vet[i];"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Soma pares: 20",
                                "description": "Soma dos pares"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "novo[i] = orig[i] * 2;"
                      },
                      {
                                "level": "II",
                                "text": "for (int i = 0; i < 3; i++) novo[i] = orig[i] * 2;"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "20 40 60",
                                "description": "Valores duplicados"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Primeiro some tudo e divida por 5."
                      },
                      {
                                "level": "II",
                                "text": "for soma += vet[i]; media = soma / 5; depois for se vet[i] > media imprima."
                      },
                      {
                                "level": "III",
                                "text": "for (int i = 0; i < 5; i++) soma += vet[i];\nint media = soma / 5;\nprintf(\"Media: %d\\n\", media);\nfor (int i = 0; i < 5; i++) {\n    if (vet[i] > media) printf(\"%d \", vet[i]);\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Media: 20\n25 30",
                                "description": "Média 20 e valores acima (25, 30)"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
    ...
    5: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Caso base: se n == 0, retorne 0."
                      },
                      {
                                "level": "II",
                                "text": "int soma(int n) { if (n == 0) return 0; return n + soma(n-1); }"
                      },
                      {
                                "level": "III",
                                "text": "int soma(int n) {\n    if (n == 0) return 0;\n    return n + soma(n - 1);\n}"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Soma(5) = 15\nSoma(10) = 55",
                                "description": "Somas recursivas de 5 e 10"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "fib(0)=0, fib(1)=1, fib(n)=fib(n-1)+fib(n-2)."
                      },
                      {
                                "level": "II",
                                "text": "if (n <= 1) return n; return fib(n-1) + fib(n-2);"
                      },
                      {
                                "level": "III",
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Caso base: se exp == 0, retorne 1."
                      },
                      {
                                "level": "II",
                                "text": "return base * pot(base, exp - 1);"
                      },
                      {
                                "level": "III",
                                "text": "int pot(int base, int exp) {\n    if (exp == 0) return 1;\n    return base * pot(base, exp - 1);\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "2^10 = 1024\n3^4 = 81",
                                "description": "Potências recursivas 2^10 e 3^4"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Se n < 10, tem 1 dígito. Senão, 1 + contarDigitos(n/10)."
                      },
                      {
                                "level": "II",
                                "text": "if (n < 10) return 1; return 1 + contarDigitos(n / 10);"
                      },
                      {
                                "level": "III",
                                "text": "int contarDigitos(int n) {\n    if (n < 10) return 1;\n    return 1 + contarDigitos(n / 10);\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Digitos de 123: 3\nDigitos de 7: 1\nDigitos de 12345: 5",
                                "description": "Contagem de dígitos"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Mova n-1 do origem para aux, mova disco n, mova n-1 de aux para destino."
                      },
                      {
                                "level": "II",
                                "text": "hanoi(n-1, origem, aux, destino); printf(...); hanoi(n-1, aux, destino, origem);"
                      },
                      {
                                "level": "III",
                                "text": "void hanoi(int n, char o, char d, char a) {\n    if (n == 1) {\n        printf(\"Mover disco 1 de %c para %c\\n\", o, d);\n        return;\n    }\n    hanoi(n-1, o, a, d);\n    printf(\"Mover disco %d de %c para %c\\n\", n, o, d);\n    hanoi(n-1, a, d, o);\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Mover disco 1 de A para C\nMover disco 2 de A para B\nMover disco 1 de C para B\nMover disco 3 de A para C\nMover disco 1 de B para A\nMover disco 2 de B para C\nMover disco 1 de A para C",
                                "description": "Sequência completa de movimentos da Torre de Hanói (3 discos)"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
    ...
    6: [
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Se vet[i] == 3, incremente cont."
                      },
                      {
                                "level": "II",
                                "text": "for (int i = 0; i < 7; i++) if (vet[i] == 3) cont++;"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Ocorrencias: 4",
                                "description": "4 ocorrências"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use for + if para comparar cada elemento."
                      },
                      {
                                "level": "II",
                                "text": "if (vet[i] == alvo) { printf(\"pos %d \", i); cont++; }"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Encontrado 3 vezes",
                                "description": "3 ocorrências de 5"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Para cada elemento, conte quantas vezes aparece."
                      },
                      {
                                "level": "II",
                                "text": "Use dois loops: o externo pega cada elemento, o interno conta."
                      },
                      {
                                "level": "III",
                                "text": "int maisFreq = vet[0], maxCont = 0;\nfor (int i = 0; i < 8; i++) {\n    int cont = 0;\n    for (int j = 0; j < 8; j++) if (vet[j] == vet[i]) cont++;\n    if (cont > maxCont) { maxCont = cont; maisFreq = vet[i]; }\n}\nprintf(\"Mais frequente: %d (%d vezes)\\n\", maisFreq, maxCont);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Mais frequente: 3",
                                "description": "3 é o mais frequente"
                      }
            ],
            validator: function(code, output) {
                          let errors = [];
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Para cada elemento, verifique se já apareceu antes."
                      },
                      {
                                "level": "II",
                                "text": "Para cada vet[i], verifique se vet[j] == vet[i] para j < i. Se não encontrou, imprima."
                      },
                      {
                                "level": "III",
        ...
        },
        {
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "Use for aninhado para percorrer a matriz."
                      },
                      {
                                "level": "II",
                                "text": "if (m[i][j] == 7) printf(\"pos (%d,%d)\\n\", i, j);"
                      },
                      {
                                "level": "III",
    ...
    7: [
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Insira o valor 5 no início de {10, 20, 30}, deslocando todos.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[4] = {10, 20, 30};\n    int tam = 3;\n    // Insira 5 no início\n    for (int i = 0; i < tam; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Desloque todos para a direita e coloque 5 na pos 0."
                      },
                      {
                                "level": "II",
                                "text": "for (int i=tam;i>0;i--) vet[i]=vet[i-1]; vet[0]=5; tam++;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i = tam; i > 0; i--) vet[i] = vet[i-1];\nvet[0] = 5;\ntam++;"
                      }
            ],
            tests: [
                      {
        ...
        {
            id: "sq7_2",
            title: "Inserir Ordenado",
            difficulty: "easy",
            xp: 20,
            description: "Insira 25 em {10, 20, 30, 40} mantendo ordenação.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[5] = {10, 20, 30, 40};\n    int tam = 4;\n    // Insira 25 na posicao correta\n    for (int i = 0; i < tam; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Encontre a posicao: 25 esta entre 20 e 30, logo pos=2."
                      },
                      {
                                "level": "II",
                                "text": "for(i=tam;i>2;i--) vet[i]=vet[i-1]; vet[2]=25; tam++;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i = tam; i > 2; i--) vet[i] = vet[i-1];\nvet[2] = 25;\ntam++;"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Remova todas as ocorrências de 3 de {1, 3, 2, 3, 4}.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[5] = {1, 3, 2, 3, 4};\n    int tam = 5;\n    // Remova todos os 3\n    for (int i = 0; i < tam; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use dois loops: um para encontrar, outro para deslocar."
                      },
                      {
                                "level": "II",
                                "text": "Use flag encontrou e desloque para esquerda."
                      },
                      {
                                "level": "III",
        ...
        {
            id: "sq7_4",
            title: "Mesclar Vetores",
            difficulty: "medium",
            xp: 25,
            description: "Dado {1, 3, 5} e {2, 4, 6}, crie um vetor mesclado ordenado {1, 2, 3, 4, 5, 6}.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int a[3] = {1, 3, 5};\n    int b[3] = {2, 4, 6};\n    int c[6];\n    // Mescle a e b em c (ordenado)\n    for (int i = 0; i < 6; i++) printf(\"%d \", c[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use 3 indices: i para a, j para b, k para c."
                      },
                      {
                                "level": "II",
                                "text": "Compare a[i] e b[j], coloque o menor em c[k]."
                      },
                      {
                                "level": "III",
                                "text": "int i=0, j=0, k=0;\nwhile(i<3 && j<3) {\n    if(a[i]<b[j]) c[k++]=a[i++];\n    else c[k++]=b[j++];\n}\nwhile(i<3) c[k++]=a[i++];\nwhile(j<3) c[k++]=b[j++];"
                      }
            ],
            tests: [
                      {
                                ...
                                "description": "Mesclagem ordenada"
                      }
            ],
        ...
        {
            id: "sq7_5",
            title: "Rotação à Direita",
            difficulty: "medium",
            xp: 25,
            description: "Rotacione {1, 2, 3, 4, 5} uma posição à direita: {5, 1, 2, 3, 4}.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[5] = {1, 2, 3, 4, 5};\n    int n = 5;\n    // Rotacione 1 posicao a direita\n    for (int i = 0; i < n; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Salve o ultimo, desloque todos para a direita, coloque o ultimo na pos 0."
                      },
                      {
                                "level": "II",
                                "text": "int last = vet[n-1]; for(i=n-1;i>0;i--) vet[i]=vet[i-1]; vet[0]=last;"
                      },
                      {
                                "level": "III",
                                "text": "int last = vet[n-1];\nfor (int i = n-1; i > 0; i--) vet[i] = vet[i-1];\nvet[0] = last;"
                      }
            ],
            tests: [
                      {
    ...
    8: [
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Encontre o elemento do meio de um vetor ordenado ímpar.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[5] = {10, 20, 30, 40, 50};\n    int meio = 2; // calcule\n    printf(\"Meio: %d\\n\", vet[meio]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "meio = (inicio + fim) / 2."
                      },
                      {
                                "level": "II",
                                "text": "int meio = (0 + 4) / 2;"
        ...
        },
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Imprima cada passo da busca binária por 60 em {10,20,30,40,50,60,70}.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[7] = {10,20,30,40,50,60,70};\n    int alvo = 60;\n    int ini = 0, fim = 6;\n    // Imprima cada passo\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Dentro do while, imprima meio e o valor."
                      },
                      {
                                "level": "II",
                                "text": "printf(\"Meio: %d (valor %d)\\n\", meio, vet[meio]);"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Verificando pos 3 (valor 40)\nVerificando pos 5 (valor 60)\nEncontrado!",
                                "description": "Passos da busca binária por 60"
                      }
            ],
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Implemente busca binária contando quantas comparações foram feitas.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[7] = {10,20,30,40,50,60,70};\n    int alvo = 40;\n    int ini = 0, fim = 6, comps = 0;\n    // Busca binaria contando comparacoes\n    printf(\"Comparacoes: %d\\n\", comps);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Incremente comps a cada comparação."
                      },
                      {
                                "level": "II",
                                "text": "comps++; antes de cada if."
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Comparacoes: 1",
                                "description": "1 comparação"
                      }
            ],
        ...
        {
            id: "sq8_4",
            title: "Remover por Busca Binária",
            difficulty: "medium",
            xp: 25,
            description: "Encontre 30 por busca binária e remova, deslocando.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[7] = {10,20,30,40,50,60,70};\n    int tam = 7;\n    // Busque 30 e remova\n    for (int i = 0; i < tam; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Primeiro encontre a pos com busca binária, depois desloque."
                      },
                      {
                                "level": "II",
                                "text": "for (int i=pos;i<tam-1;i++) vet[i]=vet[i+1]; tam--;"
                      },
                      {
                                "level": "III",
                                "text": "int ini = 0, fim = tam - 1, pos = -1;\nwhile (ini <= fim) {\n    int meio = (ini + fim) / 2;\n    if (vet[meio] == 30) { pos = meio; break; }\n    else if (vet[meio] < 30) ini = meio + 1;\n    else fim = meio - 1;\n}\nif (pos != -1) {\n    for (int i = pos; i < tam - 1; i++) vet[i] = vet[i+1];\n    tam--;\n}"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "10 20 40 50 60 70",
                                "description": "30 removido"
                      }
            ],
        ...
        {
            id: "sq8_5",
            title: "Inserir por Busca Binária",
            difficulty: "medium",
            xp: 25,
            description: "Encontre a posição correta para 35 e insira mantendo ordenação.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[6] = {10,20,30,40,50,60};\n    int tam = 6;\n    int valor = 35;\n    // Encontre posicao e insira\n    for (int i = 0; i < tam; i++) printf(\"%d \", vet[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use busca binária para encontrar a posicao (35 entre 30 e 40, logo pos=3)."
                      },
                      {
                                "level": "II",
                                "text": "for(i=tam;i>pos;i--) vet[i]=vet[i-1]; vet[pos]=35; tam++;"
                      },
                      {
                                "level": "III",
    ...
    9: [
        {
            id: "sq9_1",
            title: "Soma da Matriz",
            difficulty: "easy",
            xp: 20,
            description: "Some todos os elementos de uma matriz 3x3.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int m[3][3] = {{1,2,3},{4,5,6},{7,8,9}};\n    int soma = 0;\n    // Some todos os elementos\n    printf(\"Soma: %d\\n\", soma);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use for aninhado e some m[i][j]."
                      },
                      {
                                "level": "II",
                                "text": "for i for j soma += m[i][j];"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<3;i++) for(int j=0;j<3;j++) soma+=m[i][j];"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Imprima os elementos da diagonal principal (onde i==j).",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int m[3][3] = {{1,2,3},{4,5,6},{7,8,9}};\n    // Imprima diagonal principal\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "A diagonal tem i == j."
                      },
                      {
                                "level": "II",
                                "text": "if (i == j) printf(\"%d \", m[i][j]);"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<3;i++) printf(\"%d \", m[i][i]);"
                      }
            ],
            tests: [
                      {
        ...
        {
            id: "sq9_3",
            title: "Contar Acima da Média",
            difficulty: "medium",
            xp: 25,
            description: "Na matriz 3x3, conte quantos elementos são maiores que 5.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int m[3][3] = {{1,2,3},{4,5,6},{7,8,9}};\n    int cont = 0;\n    // Conte maiores que 5\n    printf(\"Acima de 5: %d\\n\", cont);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use for aninhado + if (m[i][j] > 5) cont++;"
                      },
                      {
                                "level": "II",
                                "text": "for i for j if (m[i][j]>5) cont++;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<3;i++) for(int j=0;j<3;j++) if(m[i][j]>5) cont++;"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Acima de 5: 4",
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Imprima a soma de cada linha de uma matriz 3x3.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int m[3][3] = {{1,2,3},{4,5,6},{7,8,9}};\n    // Imprima soma de cada linha\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Para cada linha i, some m[i][j] para j de 0 a 2."
                      },
                      {
                                "level": "II",
                                "text": "for i { soma=0; for j soma+=m[i][j]; printf(\"Linha %d: %d\\n\", i, soma); }"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Linha 0: 6\nLinha 1: 15\nLinha 2: 24",
                                "description": "Soma das linhas 0, 1 e 2"
                      }
            ],
        ...
        {
            id: "sq9_5",
            title: "Transpor e Somar",
            difficulty: "medium",
            xp: 25,
            description: "Crie a transposta da matriz e some com a original, imprimindo o resultado.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int m[3][3] = {{1,2,3},{4,5,6},{7,8,9}};\n    int r[3][3];\n    // r[i][j] = m[i][j] + m[j][i]\n    for (int i=0;i<3;i++) {\n        for (int j=0;j<3;j++) printf(\"%d \", r[i][j]);\n        printf(\"\\n\");\n    }\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "r[i][j] = m[i][j] + m[j][i];"
                      },
                      {
                                "level": "II",
                                "text": "for i for j r[i][j] = m[i][j] + m[j][i];"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<3;i++)\n    for (int j=0;j<3;j++)\n        r[i][j] = m[i][j] + m[j][i];"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "2 6 10\n6 10 14\n10 14 18",
                                "description": "Matriz 3x3 resultado da soma com transposta"
                      }
            ],
    ...
    10: [
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Imprima o comprimento de cada nome sem usar strlen.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    char nome[20] = \"Guilda\";\n    // Calcule o comprimento\n    printf(\"Tam: %d\\n\", 0);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use um while que percorre até \\0."
                      },
                      {
                                "level": "II",
                                "text": "int i=0; while(nome[i]!='\\0') i++; printf(\"Tam: %d\", i);"
                      },
                      {
                                "level": "III",
                                "text": "int i = 0;\nwhile (nome[i] != '\\0') i++;\nprintf(\"Tam: %d\\n\", i);"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Tam: 6",
                                "description": "Comprimento correto"
                      }
            ],
        ...
        },
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Inverta a string \"GUILD\" e imprima o resultado.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    char s[20] = \"GUILD\";\n    // Inverta e imprima\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Encontre o tamanho, depois imprima de trás pra frente."
                      },
                      {
                                "level": "II",
                                "text": "for (int i=tam-1;i>=0;i--) printf(\"%c\", s[i]);"
                      },
                      {
                                "level": "III",
                                "text": "int tam = 0; while(s[tam]) tam++;\nfor (int i=tam-1;i>=0;i--) printf(\"%c\", s[i]);\nprintf(\"\\n\");"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Conte as vogais em \"Programacao\".",
            starterCode: "#include <stdio.h>\n\nint main() {\n    char s[30] = \"Programacao\";\n    int cont = 0;\n    // Conte vogais\n    printf(\"Vogais: %d\\n\", cont);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Verifique se cada caractere é a,e,i,o,u (maiúscula ou minúscula)."
                      },
                      {
                                "level": "II",
                                "text": "char c = s[i]; if(c=='a'||c=='e'||c=='i'||c=='o'||c=='u') cont++;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;s[i];i++) {\n    char c = s[i];\n    if(c=='a'||c=='e'||c=='i'||c=='o'||c=='u') cont++;\n}"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Verifique se \"ovo\" é palíndromo (lê-se igual de trás pra frente).",
            starterCode: "#include <stdio.h>\n\nint main() {\n    char s[20] = \"ovo\";\n    // Verifique se eh palindromo\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Compare o primeiro com o último, o segundo com o penúltimo, etc."
                      },
                      {
                                "level": "II",
                                "text": "for (i=0;i<tam/2;i++) if(s[i]!=s[tam-1-i]) palindromo=0;"
                      },
                      {
                                "level": "III",
                                "text": "int pal = 1, tam = 0;\nwhile(s[tam]) tam++;\nfor (int i=0;i<tam/2;i++)\n    if(s[i]!=s[tam-1-i]) pal=0;\nprintf(\"%s %s\\n\", s, pal ? \"Sim\" : \"Nao\");"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "ovo Sim",
                                "description": "Verificação de palíndromo para \"ovo\""
                      }
            ],
        ...
        {
            id: "sq10_5",
            title: "Concatenar Nomes",
            difficulty: "medium",
            xp: 25,
            description: "Dados primeiro=\"Arkan\" e ultimo=\"Velor\", crie o nome completo e imprima.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    char primeiro[20] = \"Arkan\";\n    char ultimo[20] = \"Velor\";\n    char completo[50];\n    // Concatene: \"Arkan Velor\"\n    printf(\"%s\\n\", completo);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Copie o primeiro, adicione espaço, adicione o字符."
                      },
                      {
                                "level": "II",
                                "text": "int i=0; while(primeiro[i]) completo[k++]=primeiro[i++]; completo[k++]=' '; ..."
                      },
                      {
                                "level": "III",
    ...
    11: [
        {
            id: "sq11_1",
            title: "Valor e Endereço",
            difficulty: "easy",
            xp: 20,
            description: "Declare int x=42 e mostre o valor e o endereço via ponteiro.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int x = 42;\n    int *p = &x;\n    printf(\"Valor: %d\\n\", *p);\n    printf(\"Endereco via ponteiro: %d\\n\", (int)p);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use *p para valor e (int)p para endereço (simulado)."
                      },
                      {
                                "level": "II",
                                "text": "int *p = &x; *p é o valor."
                      },
                      {
                                "level": "III",
                                "text": "int *p = &x;\nprintf(\"Valor: %d\\n\", *p);"
        ...
        },
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Use um ponteiro para alterar o valor de 10 para 99.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int x = 10;\n    int *p = &x;\n    // Altere x para 99 via ponteiro\n    printf(\"x = %d\\n\", x);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use o operador de desreferência * para alterar o valor apontado por p."
                      },
                      {
                                "level": "II",
                                "text": "Faça *p = 99; no corpo da função main."
                      },
                      {
                                "level": "III",
                                "text": "*p = 99;"
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Dado um vetor, use ponteiro para acessar elementos.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int vet[3] = {10, 20, 30};\n    int *p = vet;\n    // Acesse vet[0], vet[1], vet[2] via p\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "p aponta para vet[0]. *(p+1) é vet[1], *(p+2) é vet[2]."
                      },
                      {
                                "level": "II",
                                "text": "printf(\"%d %d %d\", *p, *(p+1), *(p+2));"
                      },
                      {
                                "level": "III",
                                "text": "printf(\"%d %d %d\\n\", *p, *(p+1), *(p+2));"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "10 20 30",
                                "description": "Elementos acessados"
                      }
            ],
        ...
        {
            id: "sq11_4",
            title: "Função com Ponteiros",
            difficulty: "medium",
            xp: 25,
            description: "Crie void incrementar(int *p) que some 10 ao valor apontado.",
            ...
            hints: [
                      ...
                      {
                                "level": "II",
                                "text": "void incrementar(int *p) { *p += 10; }"
                      },
                      {
                                "level": "III",
                                "text": "void incrementar(int *p) {\n    *p += 10;\n}"
                      }
            ],
            tests: [
                      {
        ...
        {
            id: "sq11_5",
            title: "Maior via Ponteiro",
            difficulty: "medium",
            xp: 25,
            description: "Crie int* maiorPtr(int *a, int *b) que retorne ponteiro para o maior.",
            starterCode: "#include <stdio.h>\n\n// Crie maiorPtr aqui\n\nint main() {\n    int a = 10, b = 25;\n    int *r = maiorPtr(&a, &b);\n    printf(\"Maior: %d\\n\", *r);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Se *a > *b retorne a, senão retorne b."
                      },
                      {
                                "level": "II",
                                "text": "int* maiorPtr(int *a, int *b) { return (*a > *b) ? a : b; }"
                      },
                      {
                                "level": "III",
                                "text": "int* maiorPtr(int *a, int *b) {\n    if (*a > *b) return a;\n    return b;\n}"
                      }
            ],
            tests: [
                      {
    ...
    12: [
        {
            id: "sq12_1",
            title: "Struct Simples",
            difficulty: "easy",
            xp: 20,
            description: "Crie uma struct com nome, nivel e vida. Imprima a ficha.",
            starterCode: "#include <stdio.h>\n\nstruct Personagem {\n    char nome[20];\n    int nivel;\n    int vida;\n};\n\nint main() {\n    struct Personagem p;\n    // Preencha e imprima\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "strcpy(p.nome, \"Arion\"); p.nivel = 10; p.vida = 100;"
                      },
                      {
                                "level": "II",
                                "text": "printf(\"%s Niv:%d Vida:%d\", p.nome, p.nivel, p.vida);"
                      },
                      {
                                "level": "III",
                                "text": "strcpy(p.nome, \"Arion\");\np.nivel = 10;\np.vida = 100;\nprintf(\"%s Niv:%d Vida:%d\\n\", p.nome, p.nivel, p.vida);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Arion Niv:10 Vida:100",
                                "description": "Ficha do aventureiro impressa"
                      }
            ],
        ...
        {
            id: "sq12_2",
            title: "Struct com Comparação",
            difficulty: "easy",
            xp: 20,
            description: "Compare o nível de dois personagens e imprima quem é mais forte.",
            ...
            hints: [
                      {
                                "level": "I",
                                "text": "if (a.nivel > b.nivel) imprime a, senão b."
                      },
                      {
                                "level": "II",
                                "text": "if (a.nivel > b.nivel) printf(\"%s\", a.nome); else printf(\"%s\", b.nome);"
                      },
                      {
                                "level": "III",
                                "text": "if (a.nivel > b.nivel)\n    printf(\"Mais forte: %s\\n\", a.nome);\nelse\n    printf(\"Mais forte: %s\\n\", b.nome);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Mais forte: Kael",
                                "description": "Kael mais forte"
                      }
            ],
        ...
        {
            id: "sq12_3",
            title: "Struct com Função",
            difficulty: "medium",
            xp: 25,
            description: "Crie void imprimirFicha(struct Personagem p) que imprima nome e nível.",
            starterCode: "#include <stdio.h>\n\nstruct Personagem { char nome[20]; int nivel; };\n\n// Crie imprimirFicha\n\nint main() {\n    struct Personagem p = {\"Lyra\", 8};\n    imprimirFicha(p);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "void imprimirFicha(struct Personagem p) { printf(...); }"
                      },
                      {
                                "level": "II",
                                "text": "void imprimirFicha(struct Personagem p) { printf(\"%s (Niv %d)\\n\", p.nome, p.nivel); }"
                      },
                      {
                                "level": "III",
                                "text": "void imprimirFicha(struct Personagem p) {\n    printf(\"%s (Niv %d)\\n\", p.nome, p.nivel);\n}"
                      }
            ],
            tests: [
                      {
        ...
        {
            id: "sq12_4",
            title: "Múltiplas Structs",
            difficulty: "medium",
            xp: 25,
            description: "Crie 3 structs e encontre quem tem mais ouro.",
            starterCode: "#include <stdio.h>\n\nstruct Avent { char nome[20]; int ouro; };\n\nint main() {\n    struct Avent a[3] = {{\"Arion\", 300}, {\"Lyra\", 150}, {\"Kael\", 500}};\n    // Encontre quem tem mais ouro\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use for + if para comparar ouro."
                      },
                      {
                                "level": "II",
                                "text": "int idx = 0; for (i=1;i<3;i++) if(a[i].ouro>a[idx].ouro) idx=i;"
                      },
                      {
                                "level": "III",
                                "text": "int idx = 0;\nfor (int i = 1; i < 3; i++) {\n    if (a[i].ouro > a[idx].ouro) idx = i;\n}\nprintf(\"Mais ouro: %s (%d)\\n\", a[idx].nome, a[idx].ouro);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Mais ouro: Kael (500)",
                                "description": "Aventureiro com mais ouro"
                      }
            ],
        ...
        {
            id: "sq12_5",
            title: "Atualizar Struct",
            difficulty: "medium",
            xp: 25,
            description: "Crie uma função que receba ponteiro para struct e atualize a vida.",
            ...
            hints: [
                      ...
                      {
                                "level": "II",
                                "text": "void curar(struct Avent *p, int qtd) { p->vida += qtd; }"
                      },
                      {
                                "level": "III",
                                "text": "void curar(struct Avent *p, int qtd) {\n    p->vida += qtd;\n}"
                      }
            ],
            tests: [
                      {
    ...
    13: [
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Crie um vetor de 3 aventureiros e imprima todos com for.",
            starterCode: "#include <stdio.h>\n\nstruct Avent { char nome[20]; int nivel; };\n\nint main() {\n    struct Avent g[3] = {{\"Arion\", 10}, {\"Lyra\", 8}, {\"Kael\", 15}};\n    // Imprima todos com for\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "for (int i=0;i<3;i++) printf(\"%s: %d\\n\", g[i].nome, g[i].nivel);"
                      },
                      {
                                "level": "II",
                                "text": "for (int i=0;i<3;i++) printf(\"%s Niv:%d\\n\", g[i].nome, g[i].nivel);"
                      },
                      {
                                "level": "III",
                                "text": "for (int i = 0; i < 3; i++) {\n    printf(\"%s: %d\\n\", g[i].nome, g[i].nivel);\n}"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Arion: 10\nLyra: 8\nKael: 15",
                                "description": "3 aventureiros impressos"
                      }
            ],
        ...
        {
            id: "sq13_2",
            title: "Buscar no Vetor de Structs",
            difficulty: "easy",
            xp: 20,
            description: "Busque um aventureiro por nome no vetor de structs.",
            starterCode: "#include <stdio.h>\n#include <string.h>\n\nstruct Avent { char nome[20]; int nivel; };\n\nint main() {\n    struct Avent g[3] = {{\"Arion\", 10}, {\"Lyra\", 8}, {\"Kael\", 15}};\n    char busca[20] = \"Lyra\";\n    // Busque por nome\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Compare g[i].nome com busca usando strcmp."
                      },
                      {
                                "level": "II",
                                "text": "for if (strcmp(g[i].nome,busca)==0) printf(...);"
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Encontrado: Lyra Niv:8",
                                "description": "Lyra encontrada no vetor de structs"
                      }
            ],
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Some todo o ouro de todos os aventureiros do vetor.",
            starterCode: "#include <stdio.h>\n\nstruct Avent { char nome[20]; int ouro; };\n\nint main() {\n    struct Avent g[3] = {{\"Arion\", 300}, {\"Lyra\", 150}, {\"Kael\", 500}};\n    int total = 0;\n    // Some todo o ouro\n    printf(\"Total: %d\\n\", total);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Itere sobre o vetor g de 0 a 2 acumulando o campo .ouro na variável total."
                      },
                      {
                                "level": "II",
                                "text": "for (int i = 0; i < 3; i++) total += g[i].ouro;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i = 0; i < 3; i++) {\n    total += g[i].ouro;\n}"
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Ordene o vetor de structs por nível (crescente) usando selection sort.",
            starterCode: "#include <stdio.h>\n\nstruct Avent { char nome[20]; int nivel; };\n\nint main() {\n    struct Avent g[3] = {{\"Kael\", 15}, {\"Lyra\", 8}, {\"Arion\", 10}};\n    int n = 3;\n    // Ordene por nivel crescente\n    for (int i=0;i<n;i++) printf(\"%s:%d \", g[i].nome, g[i].nivel);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use selection sort trocando structs inteiras."
                      },
                      {
                                "level": "II",
                                "text": "Selection sort: para cada pos, encontre o menor e troque."
                      },
                      {
                                "level": "III",
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "Lyra:8 Arion:10 Kael:15",
        ...
        {
            id: "sq13_5",
            title: "Estatísticas da Guilda",
            difficulty: "medium",
            xp: 25,
            description: "Calcule média de nível, menor e maior nível do vetor de structs.",
            starterCode: "#include <stdio.h>\n\nstruct Avent { char nome[20]; int nivel; };\n\nint main() {\n    struct Avent g[4] = {{\"Arion\",10},{\"Lyra\",8},{\"Kael\",15},{\"Mira\",12}};\n    int n = 4;\n    // Media, menor, maior nivel\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Some todos os níveis, divida por 4. Compare para menor/maior."
                      },
                      {
                                "level": "II",
                                "text": "int soma=0, menor=g[0].nivel, maior=g[0].nivel; for..."
                      },
                      {
                                "level": "III",
                                "text": "int soma=0, menor=g[0].nivel, maior=g[0].nivel;\nfor (int i=0;i<n;i++) {\n    soma += g[i].nivel;\n    if (g[i].nivel < menor) menor = g[i].nivel;\n    if (g[i].nivel > maior) maior = g[i].nivel;\n}\nprintf(\"Media: %d Menor: %d Maior: %d\\n\", soma/n, menor, maior);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Media: 11 Menor: 8 Maior: 15",
                                "description": "Média, menor e maior nível"
                      }
            ],
    ...
    14: [
        {
            id: "sq14_1",
            title: "Bubble Sort Simples",
            difficulty: "easy",
            xp: 20,
            description: "Ordene {5, 3, 8, 1, 2} com bubble sort.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int v[5] = {5, 3, 8, 1, 2};\n    int n = 5;\n    // Bubble sort\n    for (int i=0;i<n;i++) printf(\"%d \", v[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Dois fors: externo n-1 vezes, interno compara vizinhos."
                      },
                      {
                                "level": "II",
                                "text": "for i for j if(v[j]>v[j+1]) troca;"
                      },
                      {
                                "level": "III",
        ...
        },
        {
            ...
            difficulty: "easy",
            xp: 20,
            description: "Ordene {20, 5, 15, 10} com selection sort.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int v[4] = {20, 5, 15, 10};\n    int n = 4;\n    // Selection sort\n    for (int i=0;i<n;i++) printf(\"%d \", v[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Para cada posição, encontre o menor restante e troque."
                      },
                      {
                                "level": "II",
                                "text": "minIdx=i; for j se v[j]<v[minIdx] minIdx=j; troca v[i] e v[minIdx];"
                      },
                      {
                                "level": "III",
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Modifique bubble sort para ordenar {3, 1, 4, 2} em ordem decrescente.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int v[4] = {3, 1, 4, 2};\n    int n = 4;\n    // Bubble sort decrescente\n    for (int i=0;i<n;i++) printf(\"%d \", v[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Troque > por < na comparação."
                      },
                      {
                                "level": "II",
                                "text": "if(v[j] < v[j+1]) troca;"
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<n-1;i++) {\n    for (int j=0;j<n-1-i;j++) {\n        if(v[j] < v[j+1]) {\n            int t=v[j]; v[j]=v[j+1]; v[j+1]=t;\n        }\n    }\n}"
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Ordene {4, 2, 1, 3} e conte quantas trocas foram feitas.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    int v[4] = {4, 2, 1, 3};\n    int n = 4, trocas = 0;\n    // Bubble sort contando trocas\n    for (int i=0;i<n;i++) printf(\"%d \", v[i]);\n    printf(\"\\nTrocas: %d\\n\", trocas);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Incremente trocas a cada troca."
                      },
                      {
                                "level": "II",
                                "text": "trocas++ dentro do if da troca."
                      },
                      {
                                "level": "III",
                                "text": "for (int i=0;i<n-1;i++) {\n    for (int j=0;j<n-1-i;j++) {\n        if(v[j]>v[j+1]) {\n            int t=v[j]; v[j]=v[j+1]; v[j+1]=t;\n            trocas++;\n        }\n    }\n}"
        ...
        {
            id: "sq14_5",
            title: "Ordenar Strings",
            difficulty: "medium",
            xp: 25,
            description: "Ordene alfabeticamente: {\"Kael\", \"Arion\", \"Lyra\"}.",
            starterCode: "#include <stdio.h>\n#include <string.h>\n\nint main() {\n    char nomes[3][20] = {\"Kael\", \"Arion\", \"Lyra\"};\n    int n = 3;\n    // Ordene alfabeticamente\n    for (int i=0;i<n;i++) printf(\"%s \", nomes[i]);\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Use bubble sort com strcmp para comparar strings."
                      },
                      {
                                "level": "II",
                                "text": "if(strcmp(nomes[j],nomes[j+1])>0) troca com strcpy;"
                      },
                      {
                                "level": "III",
    ...
    15: [
        {
            id: "sq15_1",
            title: "Criar e Escrever",
            difficulty: "easy",
            xp: 20,
            description: "Crie um arquivo \"teste.dat\" e escreva 3 linhas.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    // Crie arquivo e escreva 3 linhas\n    printf(\"Arquivo criado!\\n\");\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "FILE *f = fopen(\"teste.dat\",\"w\"); fprintf(f,...); fclose(f);"
                      },
                      {
                                "level": "II",
                                "text": "fopen(\"teste.dat\",\"w\"); fprintf(f,\"Linha 1\\n\"); ... fclose(f);"
                      },
                      {
                                "level": "III",
                                "text": "FILE *f = fopen(\"teste.dat\", \"w\");\nfprintf(f, \"Linha 1\\n\");\nfprintf(f, \"Linha 2\\n\");\nfprintf(f, \"Linha 3\\n\");\nfclose(f);"
                      }
            ],
            tests: [
                      {
                                ...
                                "description": "Arquivo criado e 3 linhas gravadas"
                      }
            ],
        ...
        {
            id: "sq15_2",
            title: "Ler e Imprimir",
            difficulty: "easy",
            xp: 20,
            description: "Escreva dados em arquivo, leia e imprima.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    // Escreva e leia de volta\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Escreva com fprintf, leia com fgets em loop."
                      },
                      {
                                "level": "II",
                                "text": "FILE *f=fopen(\"d.dat\",\"w\"); fprintf(f,\"Oi\\n\"); fclose(f);\nFILE *r=fopen(\"d.dat\",\"r\"); char l[100]; while(fgets(l,100,r)) printf(\"%s\",l); fclose(r);"
                      },
                      {
                                "level": "III",
                                "text": "FILE *f = fopen(\"d.dat\", \"w\");\nfprintf(f, \"Oi\\n\");\nfclose(f);\nFILE *r = fopen(\"d.dat\", \"r\");\nchar l[100];\nwhile(fgets(l, 100, r)) printf(\"%s\", l);\nfclose(r);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "Oi",
                                "description": "Dados lidos do arquivo"
                      }
            ],
        ...
        {
            id: "sq15_3",
            title: "Append ao Arquivo",
            difficulty: "medium",
            xp: 25,
            description: "Crie um arquivo, escreva, reabra em modo append e adicione mais dados.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    // Escreva, depois append\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Primeiro fopen com \"w\", depois com \"a\" (append)."
                      },
                      {
                                "level": "II",
                                "text": "FILE *f=fopen(\"d.dat\",\"w\"); fprintf(f,\"1\\n\"); fclose(f);\nf=fopen(\"d.dat\",\"a\"); fprintf(f,\"2\\n\"); fclose(f);"
                      },
                      {
                                "level": "III",
                                "text": "FILE *f = fopen(\"d.dat\", \"w\");\nfprintf(f, \"1\\n\");\nfclose(f);\nf = fopen(\"d.dat\", \"a\");\nfprintf(f, \"2\\n\");\nfclose(f);\nFILE *r = fopen(\"d.dat\", \"r\");\nchar l[100];\nwhile(fgets(l, 100, r)) printf(\"%s\", l);\nfclose(r);"
            ...
            tests: [
                      {
                                "input": "",
                                "expected": "1\n2",
                                "description": "Dados após escrita inicial e append"
                      }
            ],
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Escreva 5 linhas no arquivo e conte quantas linhas tem.",
            starterCode: "#include <stdio.h>\n\nint main() {\n    // Escreva 5 linhas, depois conte\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Leia com fgets e incremente um contador."
                      },
                      {
                                "level": "II",
                                "text": "int cont=0; while(fgets(l,100,r)) cont++; printf(\"Linhas: %d\", cont);"
                      },
                      {
                                "level": "III",
                                "text": "FILE *f = fopen(\"linhas.dat\", \"w\");\nfor (int i=0;i<5;i++) fprintf(f, \"Linha %d\\n\", i+1);\nfclose(f);\nint cont = 0;\nFILE *r = fopen(\"linhas.dat\", \"r\");\nchar l[100];\nwhile(fgets(l, 100, r)) cont++;\nprintf(\"Linhas: %d\\n\", cont);\nfclose(r);"
                      }
            ],
            tests: [
                      {
        ...
        },
        {
            ...
            difficulty: "medium",
            xp: 25,
            description: "Leia dados de um arquivo e escreva em outro (backup).",
            starterCode: "#include <stdio.h>\n\nint main() {\n    // Crie dados, salve em original, copie para backup\n    return 0;\n}",
            hints: [
                      {
                                "level": "I",
                                "text": "Abra original para leitura e backup para escrita, copie linha a linha."
                      },
                      {
                                "level": "II",
                                "text": "FILE *r=fopen(\"o.dat\",\"r\"); FILE *w=fopen(\"b.dat\",\"w\"); while(fgets(l,100,r)) fprintf(w,\"%s\",l);"
                      },
                      {
                                "level": "III",
                                "text": "FILE *r = fopen(\"o.dat\", \"r\");\nFILE *w = fopen(\"b.dat\", \"w\");\nchar l[100];\nwhile(fgets(l, 100, r)) fprintf(w, \"%s\", l);\nfclose(r);\nfclose(w);"
                      }
            ],
            tests: [
                      {
                                "input": "",
                                "expected": "[ BACKUP ] Backup Seguro",
                                "description": "Dados gravados e lidos do arquivo de backup"
                      }
            ],
